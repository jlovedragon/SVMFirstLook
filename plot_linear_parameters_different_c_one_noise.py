'''
===============================
linear kernel of svm with different parameter c and one noise
===============================
...
def test():
    ...
    # title for the plots
    titles = ['SVM (C=0.1, one noise)',
              'SVM (C=1, one noise)',
              'SVM (C=10, one noise)',
              'SVM (C=1000, one noise)']
...
# python plot_linear_parameters_different_c_one_noise.py
if __name__ == '__main__':
    test()

# import plot_linear_parameters_different_c_one_noise or reload(plot_linear_parameters_different_c_one_noise)
if __name__ == 'plot_linear_parameters_different_c_one_noise':
    print 'Testing......'
    test()
