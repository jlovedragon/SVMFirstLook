...
def test():
    ...
    for gamma in gamma_2d_range:
        ...
        clf.fit(X_2d, Y_2d)
        classifiers.append((1, gamma, clf))
...
# python plot_rbf_parameters_different_gamma.py
if __name__ == '__main__':
    test()

# import plot_rbf_parameters_different_gamma or reload(plot_rbf_parameters_different_gamma)
if __name__ == 'plot_rbf_parameters_different_gamma':
    print 'Testing......'
    test()
